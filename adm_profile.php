...
echo Dialog($kw['success'],$kw['saved'],'/login/'); 
...
<div class="row shadow" style="background-color:#fff;">
	...
	<div class="form-group row" >
		...
		<div class="col-sm-4">
			<input type="text" name="_passw" id="password" maxlength="20" class="form-control" value="<? echo $passw;?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-sm">
			...
			<a href="/main/" class="btn btn-dark  btn-sm" >
