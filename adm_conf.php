...
if($save_kw){
	$txt_1=htmlspecialchars($_POST['txt_1'],ENT_QUOTES);
	$txt_2=htmlspecialchars($_POST['txt_2'],ENT_QUOTES);
	$txt_3=htmlspecialchars($_POST['txt_3'],ENT_QUOTES);
...
<tbody>
<?
$sql="select id,kod,txt,descript,txt_1 from kw where visibled=1 and id_u=$admin_id";
$res=$conn->query($sql);
...
if($tag==2){
	...
	<div class="form-group row">
		...
		<div class="col-sm">
			<textarea id="txt_1" class="form-control form-control-sm" name="txt_1" row="3" required><?=$txt_1;?></textarea>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-sm">
			<textarea id="txt_2" class="form-control form-control-sm" name="txt_2" row="3" ><?=$txt_2;?></textarea>
		</div>
	</div>
<? /*
	<div class="form-group row">
		...
		<div class="col-sm">
			<textarea id="txt_3" class="form-control form-control-sm" name="txt_3" row="3" ><?=$txt_3;?></textarea>
		</div>
	</div>
*/ ?>
	<br><div class="form-group row">
		...
		<div class="col-sm-10">
			...
			<a href="/<?=$uri[1];?>/" class="btn btn-secondary  btn-sm" >
